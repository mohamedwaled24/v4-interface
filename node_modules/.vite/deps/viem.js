...
import {
  ...
  weiUnits,
  withResolvers
} from "./chunk-P5BKQZKB.js";
import {
  rotl,
  wrapConstructor
} from "./chunk-6VBNRQM5.js";
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-KM5N5H3G.js");
  const signature_ = (() => {
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-DKQ3OG5P.js").then((module) => module.WebSocket);
